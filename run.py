...
from mt.mvae.models import Trainer, FeedForwardVAE, ConvolutionalVAE
...
def main() -> None:
    ...
    parser.add_argument("--data", type=str, default="/Users/jding/work/mvae/data", help="Data directory.")
